...
<script>
const API_URL = 'https://fotd.000webhostapp.com/api';
...
export default {
  ...
  methods: {
    ...
    AddTrend(id, url) {
      ...
      axios.post(`${API_URL}/trend`, formData)
        .then(response => {
    ...
    deleteItem(id) {
      axios.delete(`${API_URL}/style/delete/${id}`)
        .then(response => {
    ...
    deleteProductToo(id) {
      axios.delete(`${API_URL}/productwithstyle/delete/${id}`)
        .then(response => {
    ...
    deleteTrendToo(id) {
      const ide = id;
      axios.delete(`${API_URL}/trendwithstyle/delete/${ide}`)
        .then(response => {
          this.deleteItem(ide);
